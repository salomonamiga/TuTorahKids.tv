...
<nav class="navbar navbar-expand-md navbar-light bg-white fixed-top shadow-sm">
   <a class="navbar-brand py-0 mx-lg-4" href="."> <img class="img-fluid" width="80" src="images/logo-tutorah-kids.png" alt="TutorahKids"></a>
   <button class="navbar-toggler my-1" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
   <div class="collapse navbar-collapse my-1" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
         <li class="nav-item active text-center"> <a class="nav-link fw6 text-danger" href=".">Inicio</a> </li>
         <!--        <li class="nav-item"> <a class="nav-link fw6 text-primary" href="#">Edades</a> </li>-->

         <li class="nav-item dropdown megamenu-li-- text-center">
         ...
         <li class="nav-item text-center"> <a class="nav-link fw6 text-success" href="contacto">Contacto</a> </li>
      </ul>
      ...
      </form> <a id="btn-tuto-tv" href="https://tutorah.tv/" target="_blank" class="btn btn-light btn-lg bg-gray1 text-blue fw6">TuTorah.tv</a>
   </div>
</nav>
