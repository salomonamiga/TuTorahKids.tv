    ...
    <div class="row no-gutters">
      ...
      <div class="col-12 col-lg-12 col-xl-10 px-0 p-md-1 px-lg-0 py-xl-3 pr-xl-4">
        <div class="MultixPlayer" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width:100%;" allowfullscreen="true" scrolling="no" frameborder="0">
          <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="/radiant/live_new.php" title="0" byline="0" portrait="0" width="640" height="360" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen=“true” webkitallowfullscreen="true" mozallowfullscreen="true" style="border:none;" allowfullscreen sandbox="allow-scripts allow-presentation allow-same-origin" allow="autoplay; fullscreen; picture-in-picture; xr-spatial-tracking; encrypted-media"></iframe>
        </div>
      </div>
