...
if(!isset($db)){
  $db=conecta();
  $urlLivestream = $db->getOne("SELECT urlLivestreamInfantil FROM configuraciones");
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <script>
    ...
    var src = {
      //hls: 'https://multix-x4.akamaized.net/tutorah_live/kids_abr/playlist.m3u8',
      //hls: 'https://multix1.akamaized.net/tutorah_live/kids/playlist.m3u8',
      hls: '<?=$urlLivestream?>',
