...
*/
	...
	*/
    /*
	function GetOneOld($sql,$inputarr=false) {
    ...
    */
	function GetOne($sql,$inputarr=false) {
		...
		$crecs = $ADODB_COUNTRECS;
		$ADODB_COUNTRECS = false;
        if($this->databaseType=='mssqlnative')
        {
        if(!preg_match('/select[\s]+top/i',$sql))$sql=preg_replace('/select/i','select top 1',$sql,1);    
        }

        if($this->databaseType=='mysqli')
        {
        if(!preg_match('/limit[\s]+1/i',$sql))$sql=rtrim($sql,';').' limit 1'; 
        }
	...
	*/
	function GetRow($sql,$inputarr=false) {
        ...
        ///parche para agregar top 1 o limit 1 dado que es getRow
        if($this->databaseType=='mssqlnative')
        {
        if(!preg_match('/select[\s]+top/i',$sql))$sql=preg_replace('/select/i','select top 1',$sql,1);    
        }
